  ...
  async (from, client, conText) => {
    ...
    try {
      ...
      await client.sendMessage(from, {
        ...
        mimetype: "video/mp4",
        fileName,
        contextInfo: XMD.getContextInfo('📥 DATA EXFIL', 'Type: Video/File')
      }, { quoted: mek });
    ...
    try {
      ...
      await client.sendMessage(
        from,
        {
          ...
          mimetype: "video/mp4",
          fileName,
          contextInfo: XMD.getContextInfo('📥 INSTA CLIP', 'Type: Document')
        },
        { quoted: mek }
      );
    } catch (error) {
...
kiubyxmd({
  ...
  async (from, client, conText) => {
    ...
    try {
      ...
      await client.sendMessage(from, {
        document: { url: result.video_hd },
        mimetype: "video/mp4",
        fileName,
        contextInfo: XMD.getContextInfo('📥 TWEET DATA', 'Source: X.com')
      }, { quoted: mek });
    ...
    try {
      ...
      await client.sendMessage(
        from,
        {
          ...
          mimetype: "video/mp4",
          fileName,
          contextInfo: XMD.getContextInfo('📥 TIKTOK UPLINK', 'Type: Storage')
        },
        { quoted: mek }
      );
    } catch (error) {
